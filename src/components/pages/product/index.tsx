...
export const ProductPage: React.FC = () => {
  const contents: Content[] = [
    { description: 'マップメモ共有アプリ', src: shareCheese, title: 'シェアチーズ' },
    { description: 'chrome拡張機能と連携する英単語アプリ', src: diclog, title: 'Diclog' },
    ...
    { description: 'プログラマーの経験値を可視化するアプリ', src: commit, title: 'コミットくん' },
