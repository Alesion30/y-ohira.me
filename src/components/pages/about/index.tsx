...
export const AboutPage: React.FC = () => {
  const carriers: Carrier[] = [
    ...
    { content: 'Laravelで塾の給与管理システムの開発を行う。', date: '2019年08月' },
    {
      content: 'チャレキャラ2019にて、「Passtick」というアプリを開発し、Excite賞を受賞。(賞金として5万円を獲得)',
      date: '2019年12月',
    },
    { content: 'プロジェクトマネージャーとして塾の管理システム開発を取り仕切る。', date: '2020年02月' },
    { content: '株式会社DEVELで、量子機械学習プラットフォームの開発に携わる。', date: '2020年06月' },
    ...
    { content: 'サポーターズ主催のハッカソン「技育展」で、イベント調整アプリ「Creamy」を発表', date: '2021年10月' },
    {
      content:
